...
class Register extends Component {
  ...
  getAccounts() {
    ...
    //   context.accounts = [
    //     "0xd8C8f7292b73bD5Be8292CE22AE577FEA0D66c9D",
    //     "0xd8C8f7292b73bD5Be8292CE22AE577FEA0D66c9D",
    //     "0xd8C8f7292b73bD5Be8292CE22AE577FEA0D66c9D",
    //     "0xd8C8f7292b73bD5Be8292CE22AE577FEA0D66c9D",
    //   ];
  ...
  register(e) {
    ...
    this.complainContract.methods
      .registerComplain(part, longdata, latdata, catdata)
      .send({ from: this.accounts[this.selectUser], value: reward })
      .then(function (response) {
        context.complainContract.methods
          .registerComplain(part, longdata, latdata, catdata)
          .call()
          .then(function (cid) {
            console.log("CID: " + cid);
            context.setState({
              notify: "Complain Registered.",
              notiClass: "success",
            });
      ...
      .catch(function (err) {
        context.setState({
          notify: "Error: Complain not Registered.",
          notiClass: "danger",
        });
  ...
  render() {
    return (
      <div id="register-class">
        ...
        <hr />
        <br />
        <p>To register a complain please fill the following form.</p>
        <form className="form-horizontal" onSubmit={this.formPreventDefault}>
          ...
          <div className="form-group">
            <label htmlFor="input-address" className="col-sm-2 control-label">
              Address:{" "}
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="form-group">
            <label htmlFor="input-reward" className="col-sm-2 control-label">
              Reward:{" "}
            </label>
            <div className="col-sm-10">
              <input
          ...
          <div className="form-group">
            <label htmlFor="input-desc" className="col-sm-2 control-label">
              Description:{" "}
            </label>
            <div className="col-sm-10">
              <textarea
